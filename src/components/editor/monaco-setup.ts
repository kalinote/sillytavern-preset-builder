...
export function configureMonacoTheme() {
  monaco.editor.defineTheme("preset-studio-light", {
    ...
    colors: {
      ...
      "editorBracketPairGuide.background1": "#D8DEE8",
      "editorBracketPairGuide.background2": "#D8DEE8",
      "editorBracketPairGuide.background3": "#D8DEE8",
      "editorBracketPairGuide.background4": "#D8DEE8",
      "editorBracketPairGuide.background5": "#D8DEE8",
      "editorBracketPairGuide.background6": "#D8DEE8",
      "editorBracketPairGuide.activeBackground1": "#B0BAC8",
      "editorBracketPairGuide.activeBackground2": "#B0BAC8",
      "editorBracketPairGuide.activeBackground3": "#B0BAC8",
      "editorBracketPairGuide.activeBackground4": "#B0BAC8",
      "editorBracketPairGuide.activeBackground5": "#B0BAC8",
      "editorBracketPairGuide.activeBackground6": "#B0BAC8",
